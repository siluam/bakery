{
    ...
    outputs = inputs@{ self, flake-utils, settings, ... }: with builtins; with settings.lib; with flake-utils.lib; settings.mkOutputs {
        inherit inputs;
        callPackage = { buildPythonPackage, pythonOlder, poetry-core, oreo, pytest-hy, pytest-randomly, pytest-parametrized, pytestCheckHook, py, pname, pytest-custom_exit_code, pytest-sugar }: let
            owner = "syvlorg";
        in buildPythonPackage rec {
            ...
            checkInputs = [ pytestCheckHook pytest-hy pytest-randomly pytest-parametrized pytest-custom_exit_code pytest-sugar ];
            postPatch = ''
